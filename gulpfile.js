/**
 * AngularJS SPA Starter: Build, watch and other useful tasks
 *
...
gulp.task('default', ['browser-sync', 'sass', 'minify-css'], function() {
  ...
  gulp.watch(['*.html', 'components/**/*.html', 'views/*.html', 'views/**/*.html'], ['bs-reload']);
  gulp.watch(['app/*.js', 'components/**/*.js', 'js/*.js', 'app/controllers/*.js'], ['bs-reload']);
